        ...
        <div className={cn("flex items-center gap-1 flex-1 md:flex-none md:gap-2", openTabs.length === 3 && "overflow-x-auto scrollbar-styled")}>
          {displayTabs.map((tab) => (
            <div
              key={tab.label}
              className={cn(
                "flex items-center gap-1 px-3 sm:px-4 md:px-5 py-1.5 md:py-2 text-xs sm:text-sm md:text-base font-medium transition-colors rounded-sm whitespace-nowrap group cursor-pointer",
                tab.active
