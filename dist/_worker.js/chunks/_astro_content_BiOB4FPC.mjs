...
import { ah as objectType, a8 as dateType, a1 as arrayType, ax as stringType, c as AstroError, Z as UnknownContentCollectionError, a5 as createComponent, S as RenderUndefinedEntryError, az as unescapeHTML, as as renderTemplate, ab as escape, at as renderUniqueStylesheet, ap as renderScriptElement, a6 as createHeadAndContent, aj as renderComponent } from './astro/server_CEX0AJg6.mjs';
import { r as removeBase, b as isRemotePath, p as prependForwardSlash } from './path_y9gdWwIq.mjs';
import { V as VALID_INPUT_FORMATS } from './consts_CBOg0Lc-.mjs';
import { u as unflatten } from './parse_DSt6RPqT.mjs';
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content_CLFHUDsd.mjs');
...
const __vite_import_meta_env__ = {"ASSETS_PREFIX": undefined, "BASE_URL": "/", "DEV": false, "MODE": "production", "PROD": true, "SITE": "https://lamp.delivery", "SSR": true};
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('./_astro_assets_BMHlg-Jy.mjs').then(n => n._);
